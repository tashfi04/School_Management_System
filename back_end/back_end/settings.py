...
SECRET_KEY = 'zw_p5)jny7f*ktv586e^(_54!@k-(@^*0ntg=atgb7njbv=)u1'
...
LOCAL_APPS = [
    ...
    'academic_sessions.apps.AcademicSessionsConfig',
...
JWT_AUTH = {
    ...
    # extend to solve session unauthorized after a short time to check what happened
