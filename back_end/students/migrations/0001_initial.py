# Generated by Django 3.0.5 on 2020-05-20 01:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Student',
            fields=[
                ('user_name', models.CharField(blank=True, max_length=50, primary_key=True, serialize=False)),
                ...
                ('current_class', models.IntegerField(choices=[('0', 'Nursery'), ('1', 'One'), ('2', 'Two'), ('3', 'Three'), ('4', 'Four'), ('5', 'Five'), ('6', 'Six'), ('7', 'Seven'), ('8', 'Eight'), ('9', 'Nine'), ('10', 'Ten')])),
