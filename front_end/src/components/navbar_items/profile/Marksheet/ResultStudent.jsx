...
function ResultStudent() {
    ...
    useEffect(() => {
        ...
        const checkExtraSubject = async () => {
            ...
            for (
                ...
                tempSubList = [
                    ...tempSubList,
                    result[0].marksheet_set[i].exam.subject,
                ];
            }
                    ...
                    <>
                        {result[1].marksheet_set.map((iitem) => (
                            <React.Fragment key={++KEY}>
                                {item.exam.subject === iitem.exam.subject ? (
                                    <React.Fragment key={++check}>
                                        <td>{iitem.class_test_marks}</td>
                                        <td>
                                            {iitem.term_test_subjective_marks}
                                        </td>
                                        <td>
                                            {iitem.term_test_objective_marks}
                                        </td>
    ...
    if (Object.keys(result).length > 1) {
        extraResult = result[1].marksheet_set.map((item) => (
            <tr key={++KEY}>
                {midSubList.includes(item.exam.subject) ? (
                    <React.Fragment></React.Fragment>
                ) : (
                    <React.Fragment>
                        <td>{item.exam.subject}</td>
                        ...
                        {Object.keys(result).length > 0 ? (
                            <React.Fragment>
                                <Row>
                                    ...
                                    >
                                        Total Marks: {result[0].total_marks}
                                        <br />
                                        GPA: {result[0].GPA}
                                        <br />
                                        Letter Grade: {result[0].letter_grade}
                                        <br />
                                    ...
                                    {result[1] ? (
                                        ...
                                        style={{ textAlign: "left" }}
                                    >
                                        Total Marks: {result[1].total_marks}
                                        <br />
                                        GPA: {result[1].GPA}
                                        <br />
                                        Letter Grade: {result[1].letter_grade}
                                        <br />
